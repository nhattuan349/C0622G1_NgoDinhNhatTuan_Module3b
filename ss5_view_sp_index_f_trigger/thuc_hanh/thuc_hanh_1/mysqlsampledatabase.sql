...
-- Và để tìm thông tin của khách hàng có tên là Land Of Toys Inc., bạn sẽ query như sau:
...
-- Nhìn lại câu query của chúng ta mới thật khủng khiếp. 
-- Không có Possible_keys nào được sử dụng, MySQL phải duyệt qua 17123 
-- bản ghi mới tìm ra cái ta cần (Hãy tưởng tượng 1 Forum sẽ có đến hơn 500.000 bản ghi).
